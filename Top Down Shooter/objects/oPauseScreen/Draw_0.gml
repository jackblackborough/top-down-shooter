...
draw_text_transformed(_camX + _camW/2,  _camY + _camH/2 - restartOffset, " * PRESS SPACE TO CONTINUE * ", 2, 2, 0);

draw_set_halign(fa_left);
draw_set_valign(fa_top);/// @description Insert description here
